...
function LayerZeroTracker({
	...
	const [hoverLzScan, setHoverLzScan] = useState<boolean>(false);
	...
	return (
		<div className="w-full">
			<div className="flex items-center justify-between">
				<span>Track on LayerZeroScan</span>
				<a
					href={lzScanUrl}
					target="_blank"
					...
					onMouseEnter={() => setHoverLzScan(true)}
					onMouseLeave={() => setHoverLzScan(false)}
				>
...
export default LayerZeroTracker;
